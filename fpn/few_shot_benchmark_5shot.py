...
root='/home/DL/rail_detection/miniImageNet_5shot'
# ------------------------------------------------------------------------------------------------------
...
def prep_data_single(im_path,cur_bbs=None):
    ...
    if type(im_path) == str:
        ...
        im_path = im_path.replace('/DL/rail_detection/data/miniimagenet/images','/home/dataset/miniimagenet/images')
        ...
        for i_cat, cat in enumerate(epi_cats):
            for nImg in train_nImg[cat]:
                ...
                if args.display==1:
                    ...
                    cur_img = cur_img.replace('/dccstor/leonidka1/data/miniimagenet/images','/home/DL/dataset/miniimagenet/images')
